/**
 * Centralized logging utility for Electron processes
...
class Logger {
    constructor() {
        ...
        const isPackaged = process.env.NODE_ENV === 'production' || (typeof process.defaultApp === 'undefined');
        const defaultLevel = isPackaged ? LOG_LEVELS.INFO : LOG_LEVELS.DEBUG;
